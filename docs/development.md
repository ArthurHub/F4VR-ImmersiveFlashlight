...
## Building
Clone repo and setup [F4VR-CommonFramework](https://github.com/ArthurHub/F4VR-CommonFramework) submodule:
```
...
```
- Open `.../Fallout-4-VR-Body/build/ImmersiveFlashlightVR.slnx` in VS2026.
...
- Logs are found in `%USERPROFILE%\Documents\My Games\Fallout4VR\F4SE`
  - `ImmersiveFlashlightVR.log` for main logs
