...
#define ROCK_PROVIDER_CALL __cdecl
    ...
    enum class RockProviderHandInputSuppressionFlagV1 : std::uint32_t
    {
        ...
        SuppressConfigModeChord = static_cast<std::uint32_t>(SuppressNormalGrabPress) | static_cast<std::uint32_t>(SuppressGrabRelease) |
            static_cast<std::uint32_t>(SuppressHeldWeaponTriggerEquip) | static_cast<std::uint32_t>(SuppressGameplayCandidates),
    };
    ...
    [[nodiscard]] inline constexpr bool hasHandInputSuppressionFlagV1(std::uint32_t flags, RockProviderHandInputSuppressionFlagV1 flag)
    {
        return (flags & static_cast<std::uint32_t>(flag)) != 0;
    }

    [[nodiscard]] inline constexpr bool hasWeaponPartTargetFlagV1(std::uint32_t flags, RockProviderWeaponPartTargetFlagV1 flag)
    {
        return (flags & static_cast<std::uint32_t>(flag)) != 0;
    }
    ...
    [[nodiscard]] inline constexpr bool hasTouchGrabTargetFlagV1(std::uint32_t flags, RockProviderTouchGrabTargetFlagV1 flag)
    {
        return (flags & static_cast<std::uint32_t>(flag)) != 0;
    }

    [[nodiscard]] inline constexpr bool hasNativeAnimationAuthorityFlagV1(std::uint32_t flags, RockProviderNativeAnimationAuthorityFlagV1 flag)
    {
        return (flags & static_cast<std::uint32_t>(flag)) != 0;
    }

    [[nodiscard]] inline constexpr bool hasEquippedWeaponHandlingFlagV1(std::uint32_t flags, RockProviderEquippedWeaponHandlingFlagV1 flag)
    {
        return (flags & static_cast<std::uint32_t>(flag)) != 0;
    }
    ...
    struct RockProviderRawWandButtonStateV1
    {
        ...
        RockProviderInputAvailabilityReasonV1 availabilityReason{ RockProviderInputAvailabilityReasonV1::HookNotSampled };
    };
    ...
    struct RockProviderLogicalInputActionStateV1
    {
        ...
        std::uint32_t version{ ROCK_PROVIDER_API_VERSION };
        RockProviderLogicalInputActionV1 action{ RockProviderLogicalInputActionV1::Jump };
        std::uint32_t available{ 0 };
        std::uint32_t held{ 0 };
        RockProviderInputAvailabilityReasonV1 availabilityReason{ RockProviderInputAvailabilityReasonV1::HookNotSampled };
        std::uint64_t sampleSequence{ 0 };
    ...
    struct RockProviderPlayerControllerStateV1
    {
        ...
        std::uint64_t frameIndex{ 0 };
        std::uint32_t flags{ 0 };
        RockProviderPlayerControllerImplementationV1 implementation{ RockProviderPlayerControllerImplementationV1::Unknown };
        RockProviderPlayerSupportStateV1 supportState{ RockProviderPlayerSupportStateV1::Unsupported };
        std::uint32_t reserved0{ 0 };
    ...
    {
        std::uint32_t size{ sizeof(RockProviderPlayerControllerJumpRequestV1) };
        std::uint32_t version{ ROCK_PROVIDER_API_VERSION };
    ...
    {
        std::uint32_t size{ sizeof(RockProviderColliderVisualizationRequestV1) };
        std::uint32_t version{ ROCK_PROVIDER_API_VERSION };
        std::uint64_t weaponGenerationKey{ 0 };
        std::uint32_t bodyId{ 0x7FFF'FFFF };
        std::uint32_t partKind{ 0 };
    ...
    struct RockProviderHandInteractionStateV1
    {
        ...
        RockProviderSurfaceGripModeV1 surfaceGripMode{ RockProviderSurfaceGripModeV1::CollisionAnchor };
    };
    ...
    struct RockProviderEquippedWeaponStateV1
    {
        ...
        RockProviderEquippedWeaponTransitionSourceV1 transitionSource{ RockProviderEquippedWeaponTransitionSourceV1::Unknown };
        RockProviderEquippedWeaponTransitionResultV1 terminalResult{ RockProviderEquippedWeaponTransitionResultV1::None };
        std::uint32_t worldGeneration{ 0 };
        std::uint32_t skeletonGeneration{ 0 };
        std::uint32_t providerGeneration{ 0 };
        std::uint32_t reserved[7]{};
    ...
    struct RockProviderWeaponPartDriveApplicationResultV1
    {
        ...
        std::uint32_t groupId{ 0 };
        std::uint32_t priority{ 0 };
        RockProviderWeaponPartDriveApplicationV1 result{ RockProviderWeaponPartDriveApplicationV1::Unknown };
    ...
    struct RockProviderScopeSightStateV1
    {
        ...
        std::uint32_t weaponFormId{ 0 };
        std::uint32_t flags{ 0 };
        RockProviderScopeActivationSourceV1 activationSource{ RockProviderScopeActivationSourceV1::None };
    ...
    struct RockProviderSemanticHandContactV1
    {
        ...
        std::uint32_t targetFormId{ 0 };
        std::uint32_t flags{ 0 };
        RockProviderSemanticContactStateV1 contactState{ RockProviderSemanticContactStateV1::Continued };
    ...
    struct RockProviderHandInputSuppressionStateV1
    {
        ...
        RockProviderSuppressionInvalidationReasonV1 lastInvalidationReason{ RockProviderSuppressionInvalidationReasonV1::None };
        std::uint32_t worldGeneration{ 0 };
        std::uint32_t skeletonGeneration{ 0 };
        std::uint32_t providerGeneration{ 0 };
        std::uint32_t reserved[5]{};
    ...
    struct RockProviderTouchGrabTargetV1
    {
        ...
        RockProviderTouchGrabKindV1 kind{ RockProviderTouchGrabKindV1::FixedAnchor };
        std::uint32_t flags{ 0 };
        std::uint32_t bodyId{ 0x7FFF'FFFF };
    ...
    struct RockProviderTouchGrabStateV1
    {
        ...
        std::uint32_t targetGeneration{ 0 };
        RockProviderTouchGrabKindV1 kind{ RockProviderTouchGrabKindV1::FixedAnchor };
        RockProviderTouchGrabPhaseV1 phase{ RockProviderTouchGrabPhaseV1::Inactive };
        RockProviderTouchGrabReleaseReasonV1 releaseReason{ RockProviderTouchGrabReleaseReasonV1::None };
        std::uint32_t bodyId{ 0x7FFF'FFFF };
        std::uint32_t referenceFormId{ 0 };
        std::uint32_t referenceNativeHandle{ 0 };
    ...
    using RockProviderAnimationPhaseCallbackV1 = void(ROCK_PROVIDER_CALL*)(const RockProviderAnimationPhaseContextV1* context, void* userData);
    ...
    enum class RockProviderTargetDetailFlagV1 : std::uint32_t
    {
        ...
        Normal = 1u << 3,
        MeshPart = 1u << 4,
        ActivationBlocked = 1u << 5,
        OpenState = 1u << 6,
        FurnitureUse = 1u << 7,
        PowerArmorClassification = 1u << 8,
        PowerArmorFrame = 1u << 9,
        PowerArmorActor = 1u << 10,
    };
    ...
    struct RockProviderApi
    {
        ...
        bool(ROCK_PROVIDER_CALL* registerExternalBodiesV1)(std::uint64_t ownerToken, const RockProviderExternalBodyRegistration* bodies, std::uint32_t bodyCount);
        ...
        std::uint32_t(ROCK_PROVIDER_CALL* copyWeaponEvidenceDetailPointsV1)(std::uint32_t bodyId, RockProviderPoint3* outPoints, std::uint32_t maxPoints);
        ...
        RockProviderResultV1(ROCK_PROVIDER_CALL* registerConsumerV1)(const RockProviderConsumerRegistrationV1* registration, RockProviderConsumerHandleV1* outHandle);
        ...
        std::uint32_t(ROCK_PROVIDER_CALL* getExternalContactSnapshotForOwnerV1)(std::uint64_t ownerToken, RockProviderExternalContactV1* outContacts, std::uint32_t maxContacts);
        RockProviderResultV1(ROCK_PROVIDER_CALL* requestForceGrabV1)(std::uint64_t ownerToken, const RockProviderForceGrabRequestV1* request, std::uint64_t* outCommandId);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* getInteractionCommandResultV1)(std::uint64_t ownerToken, std::uint64_t commandId, RockProviderInteractionCommandResultV1* outResult);
        RockProviderResultV1(ROCK_PROVIDER_CALL* requestForceReleaseV1)(std::uint64_t ownerToken, const RockProviderForceReleaseRequestV1* request, std::uint64_t* outCommandId);
        RockProviderResultV1(ROCK_PROVIDER_CALL* requestThrownDropV1)(std::uint64_t ownerToken, const RockProviderThrownDropRequestV1* request, std::uint64_t* outCommandId);
        RockProviderResultV1(ROCK_PROVIDER_CALL* setHandInputSuppressionV1)(std::uint64_t ownerToken, const RockProviderHandInputSuppressionRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearHandInputSuppressionV1)(std::uint64_t ownerToken, RockProviderHand hand);
        RockProviderResultV1(ROCK_PROVIDER_CALL* setWeaponPartTargetsV1)(std::uint64_t ownerToken, const RockProviderWeaponPartTargetV1* targets, std::uint32_t targetCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearWeaponPartTargetsV1)(std::uint64_t ownerToken);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* setWeaponPartDriveTargetsV1)(std::uint64_t ownerToken, const RockProviderWeaponPartDriveTargetV1* targets, std::uint32_t targetCount);
        ...
        RockProviderResultV1(ROCK_PROVIDER_CALL* setNativeAnimationAuthorityV1)(std::uint64_t ownerToken, const RockProviderNativeAnimationAuthorityRequestV1* request);
        ...
        RockProviderResultV1(ROCK_PROVIDER_CALL* registerAnimationPhaseCallbackV1)(std::uint64_t ownerToken, RockProviderAnimationPhaseCallbackV1 callback, void* userData,
            std::uint64_t* outCallbackToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* unregisterAnimationPhaseCallbackV1)(std::uint64_t ownerToken, std::uint64_t callbackToken);
        bool(ROCK_PROVIDER_CALL* getEquippedWeaponGripStateV1)(std::uint64_t ownerToken, RockProviderEquippedWeaponGripStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* setHandVisualAuthorityV1)(std::uint64_t ownerToken, const RockProviderHandVisualAuthorityRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearHandVisualAuthorityV1)(std::uint64_t ownerToken, RockProviderHand hand);
        RockProviderResultV1(ROCK_PROVIDER_CALL* publishNativeAnimationRuntimeV1)(std::uint64_t ownerToken, const RockProviderNativeAnimationRuntimePublicationV1* publication);
        RockProviderResultV1(ROCK_PROVIDER_CALL* setEquippedWeaponHandlingAuthorityV1)(std::uint64_t ownerToken, const RockProviderEquippedWeaponHandlingRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearEquippedWeaponHandlingAuthorityV1)(std::uint64_t ownerToken);
        bool(ROCK_PROVIDER_CALL* getEquippedWeaponHandlingStateV1)(RockProviderEquippedWeaponHandlingStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* publishDebugOverlayV1)(std::uint64_t ownerToken, const RockProviderDebugOverlayPublicationV1* publication);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearDebugOverlayV1)(std::uint64_t ownerToken);
        /*
         ...
         */
        bool(ROCK_PROVIDER_CALL* getPresentedHandFrameV1)(RockProviderHand hand, RockProviderHandFrameV1* outFrame);
         ...
         */
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* registerFrameCallbackForOwnerV1)(std::uint64_t ownerToken, RockProviderFrameCallback callback, void* userData, std::uint64_t* outCallbackToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* unregisterFrameCallbackForOwnerV1)(std::uint64_t ownerToken, std::uint64_t callbackToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getHandInteractionStateV1)(std::uint64_t ownerToken, RockProviderHand hand, RockProviderHandInteractionStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyProviderEventsSinceV1)(std::uint64_t ownerToken, std::uint64_t afterSequence, RockProviderEventV1* outEvents,
            std::uint32_t maxEvents, RockProviderEventStreamStateV1* outStreamState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getEquippedWeaponStateV1)(std::uint64_t ownerToken, RockProviderEquippedWeaponStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* registerExternalBodiesForScopeV1)(std::uint64_t ownerToken, std::uint64_t scopeToken,
            const RockProviderExternalBodyRegistration* bodies, std::uint32_t bodyCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearExternalBodiesForScopeV1)(std::uint64_t ownerToken, std::uint64_t scopeToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyExternalContactsSinceV1)(std::uint64_t ownerToken, std::uint64_t scopeToken, std::uint64_t afterSequence,
            RockProviderExternalContactRecordV1* outContacts, std::uint32_t maxContacts, RockProviderExternalContactStreamStateV1* outStreamState);
        /*
         ...
         */
        RockProviderResultV1(ROCK_PROVIDER_CALL* queryWeaponPartTargetResolutionV1)(std::uint64_t ownerToken, const RockProviderWeaponPartResolutionQueryV1* query,
            RockProviderWeaponPartResolutionResultV1* outResolution);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyWeaponPartPoseSnapshotV1)(std::uint64_t ownerToken, RockProviderWeaponPartPoseV1* outParts, std::uint32_t maxParts,
            std::uint32_t* outPartCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyWeaponPartDriveApplicationResultsV1)(std::uint64_t ownerToken, RockProviderWeaponPartDriveApplicationResultV1* outResults,
            std::uint32_t maxResults, std::uint32_t* outResultCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getScopeSightStateV1)(std::uint64_t ownerToken, RockProviderScopeSightStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getWeaponCompositionStateV1)(std::uint64_t ownerToken, RockProviderWeaponCompositionStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyWeaponCompositionEntriesV1)(std::uint64_t ownerToken, RockProviderWeaponCompositionEntryV1* outEntries,
            std::uint32_t maxEntries, std::uint32_t* outEntryCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getSelectedAuthoredGripPoseV1)(std::uint64_t ownerToken, RockProviderAuthoredGripPoseV1* outPose);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getPresentedHandPoseV1)(std::uint64_t ownerToken, RockProviderHand hand, RockProviderPresentedHandPoseV1* outPose);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copySemanticHandContactsV1)(std::uint64_t ownerToken, RockProviderHand hand, std::uint32_t maxFramesSinceContact,
            RockProviderSemanticHandContactV1* outContacts, std::uint32_t maxContacts, std::uint32_t* outContactCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyPlayerColliderDescriptorsV1)(std::uint64_t ownerToken, RockProviderPlayerColliderDescriptorV1* outDescriptors,
            std::uint32_t maxDescriptors, std::uint32_t* outDescriptorCount);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* getHandCollisionAvailabilityV1)(std::uint64_t ownerToken, RockProviderHand hand, RockProviderHandCollisionAvailabilityV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* cancelInteractionCommandV1)(std::uint64_t ownerToken, std::uint64_t commandId);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* getHandInputSuppressionStateV1)(std::uint64_t ownerToken, RockProviderHand hand, RockProviderHandInputSuppressionStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* acquireOffhandReservationV1)(std::uint64_t ownerToken, const RockProviderOffhandReservationRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* renewOffhandReservationV1)(std::uint64_t ownerToken, const RockProviderOffhandReservationRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* releaseOffhandReservationV1)(std::uint64_t ownerToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getOffhandReservationStateV1)(std::uint64_t ownerToken, RockProviderOffhandReservationStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearNativeAnimationRuntimeV1)(std::uint64_t ownerToken);
        /*
         ...
         */
        RockProviderResultV1(ROCK_PROVIDER_CALL* setTouchGrabTargetsForScopeV1)(std::uint64_t ownerToken, std::uint64_t scopeToken, const RockProviderTouchGrabTargetV1* targets,
            std::uint32_t targetCount);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearTouchGrabTargetsForScopeV1)(std::uint64_t ownerToken, std::uint64_t scopeToken);
        RockProviderResultV1(ROCK_PROVIDER_CALL* copyTouchGrabStatesForScopeV1)(std::uint64_t ownerToken, std::uint64_t scopeToken, RockProviderTouchGrabStateV1* outStates,
            std::uint32_t maxStates, std::uint32_t* outStateCount);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* requestTouchGrabYieldV1)(std::uint64_t ownerToken, std::uint64_t scopeToken, std::uint64_t targetId, std::uint32_t targetGeneration);
        RockProviderResultV1(ROCK_PROVIDER_CALL* requestEquippedWeaponHandV1)(std::uint64_t ownerToken, const RockProviderEquippedWeaponHandRequestV1* request);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* queryWorldRaycastV1)(std::uint64_t ownerToken, const RockProviderWorldRaycastRequestV1* request, RockProviderWorldRaycastResultV1* outResult);
        RockProviderResultV1(ROCK_PROVIDER_CALL* setColliderVisualizationOverrideV1)(std::uint64_t ownerToken, const RockProviderColliderVisualizationRequestV1* request);
        RockProviderResultV1(ROCK_PROVIDER_CALL* clearColliderVisualizationOverrideV1)(std::uint64_t ownerToken);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* getLogicalInputActionStateV1)(std::uint64_t ownerToken, RockProviderLogicalInputActionV1 action, RockProviderLogicalInputActionStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* getPlayerControllerStateV1)(std::uint64_t ownerToken, std::uint32_t queryFlags, RockProviderPlayerControllerStateV1* outState);
        RockProviderResultV1(ROCK_PROVIDER_CALL* requestPlayerControllerJumpV1)(std::uint64_t ownerToken, const RockProviderPlayerControllerJumpRequestV1* request);
        ...
        RockProviderResultV1(ROCK_PROVIDER_CALL* getHandTargetDetailsV1)(std::uint64_t ownerToken, RockProviderHand hand, RockProviderHandTargetDetailsV1* outDetails);
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* queryReferenceInteractionV1)(std::uint64_t ownerToken, const RockProviderReferenceQueryV1* query, RockProviderReferenceInteractionV1* outState);
        // PowerArmor capability. Returns copied live bone poses, never pointers.
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* queryPowerArmorTargetV1)(std::uint64_t ownerToken, const RockProviderReferenceQueryV1* query, RockProviderPowerArmorTargetV1* outTarget);
        ...
        RockProviderResultV1(
            ROCK_PROVIDER_CALL* requestPowerArmorGrabV1)(std::uint64_t ownerToken, const RockProviderPowerArmorGrabRequestV1* request, std::uint64_t* outCommandId);

        [[nodiscard]] static int initialize(const std::uint32_t minVersion = ROCK_PROVIDER_API_VERSION, const std::uint32_t minProviderApiByteSize = 0)
        {
            if (inst) {
                if (negotiatedApiVersion < minVersion) {
                    return 4;
                }
                return minProviderApiByteSize == 0 || (negotiatedTableByteSize != 0 && negotiatedTableByteSize >= minProviderApiByteSize) ? 0 : 5;
            }
            ...
            const auto getDescriptor = reinterpret_cast<GetDescriptorFn>(GetProcAddress(rockDll, "ROCKAPI_GetDescriptorV1"));
            if (getDescriptor) {
                const auto* descriptor = getDescriptor();
                constexpr auto minimumDescriptorBytes =
                    static_cast<std::uint32_t>(offsetof(RockProviderApiDescriptorV1, table) + sizeof(std::declval<RockProviderApiDescriptorV1>().table));
                constexpr auto minimumTableBytes = static_cast<std::uint32_t>(sizeof(std::declval<RockProviderApi>().getVersion));
                if (!descriptor || descriptor->size < minimumDescriptorBytes || !descriptor->table || descriptor->tableByteSize < minimumTableBytes) {
                    return 6;
                }
                if (descriptor->apiVersion < minVersion) {
                    return 4;
                }
                if (minProviderApiByteSize != 0 && descriptor->tableByteSize < minProviderApiByteSize) {
                    return 5;
                }
    ...
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_RAW_WAND_THUMBSTICK_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getRawWandThumbstickV1) + sizeof(std::declval<RockProviderApi>().getRawWandThumbstickV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_POWER_ARMOR_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestPowerArmorGrabV1) + sizeof(std::declval<RockProviderApi>().requestPowerArmorGrabV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_FORCE_GRAB_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getInteractionCommandResultV1) + sizeof(std::declval<RockProviderApi>().getInteractionCommandResultV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_FORCE_RELEASE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestForceReleaseV1) + sizeof(std::declval<RockProviderApi>().requestForceReleaseV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_THROWN_DROP_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestThrownDropV1) + sizeof(std::declval<RockProviderApi>().requestThrownDropV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_HAND_INPUT_SUPPRESSION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearHandInputSuppressionV1) + sizeof(std::declval<RockProviderApi>().clearHandInputSuppressionV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WEAPON_PART_INTERACTION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearWeaponPartDriveTargetsV1) + sizeof(std::declval<RockProviderApi>().clearWeaponPartDriveTargetsV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WEAPON_CLASSIFICATION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, queryEquippedWeaponClassificationV1) + sizeof(std::declval<RockProviderApi>().queryEquippedWeaponClassificationV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WEAPON_PART_GRIP_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getWeaponPartGripStateV1) + sizeof(std::declval<RockProviderApi>().getWeaponPartGripStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_RAW_WAND_BUTTON_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getRawWandButtonStateV1) + sizeof(std::declval<RockProviderApi>().getRawWandButtonStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PIPBOY_INPUT_SUPPRESSION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, isNativePipboyInputSuppressedV1) + sizeof(std::declval<RockProviderApi>().isNativePipboyInputSuppressedV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WEAPON_EMITTERS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, copyWeaponEmittersV1) + sizeof(std::declval<RockProviderApi>().copyWeaponEmittersV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_NATIVE_ANIMATION_AUTHORITY_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getNativeAnimationAuthorityStateV1) + sizeof(std::declval<RockProviderApi>().getNativeAnimationAuthorityStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_ANIMATION_PHASES_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, unregisterAnimationPhaseCallbackV1) + sizeof(std::declval<RockProviderApi>().unregisterAnimationPhaseCallbackV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_GRIP_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getEquippedWeaponGripStateV1) + sizeof(std::declval<RockProviderApi>().getEquippedWeaponGripStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_HAND_VISUAL_AUTHORITY_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearHandVisualAuthorityV1) + sizeof(std::declval<RockProviderApi>().clearHandVisualAuthorityV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_NATIVE_ANIMATION_RUNTIME_PROVIDER_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, publishNativeAnimationRuntimeV1) + sizeof(std::declval<RockProviderApi>().publishNativeAnimationRuntimeV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_HANDLING_AUTHORITY_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getEquippedWeaponHandlingStateV1) + sizeof(std::declval<RockProviderApi>().getEquippedWeaponHandlingStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_DEBUG_OVERLAY_PUBLICATION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearDebugOverlayV1) + sizeof(std::declval<RockProviderApi>().clearDebugOverlayV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PRESENTED_HAND_FRAMES_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getPresentedHandFrameV1) + sizeof(std::declval<RockProviderApi>().getPresentedHandFrameV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EXTENDED_LIMITS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getPublicStructureSizeV1) + sizeof(std::declval<RockProviderApi>().getPublicStructureSizeV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_OWNER_FRAME_CALLBACKS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, unregisterFrameCallbackForOwnerV1) + sizeof(std::declval<RockProviderApi>().unregisterFrameCallbackForOwnerV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_HAND_INTERACTION_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getHandInteractionStateV1) + sizeof(std::declval<RockProviderApi>().getHandInteractionStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PROVIDER_EVENTS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, copyProviderEventsSinceV1) + sizeof(std::declval<RockProviderApi>().copyProviderEventsSinceV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getEquippedWeaponStateV1) + sizeof(std::declval<RockProviderApi>().getEquippedWeaponStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EXTERNAL_BODY_SCOPES_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, copyExternalContactsSinceV1) + sizeof(std::declval<RockProviderApi>().copyExternalContactsSinceV1));
    ...
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_SCOPE_SIGHT_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getScopeSightStateV1) + sizeof(std::declval<RockProviderApi>().getScopeSightStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WEAPON_COMPOSITION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, copyWeaponCompositionEntriesV1) + sizeof(std::declval<RockProviderApi>().copyWeaponCompositionEntriesV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_POSE_READBACK_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getPresentedHandPoseV1) + sizeof(std::declval<RockProviderApi>().getPresentedHandPoseV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_SEMANTIC_HAND_CONTACTS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, copySemanticHandContactsV1) + sizeof(std::declval<RockProviderApi>().copySemanticHandContactsV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PLAYER_COLLIDERS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getHandCollisionAvailabilityV1) + sizeof(std::declval<RockProviderApi>().getHandCollisionAvailabilityV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_COMMAND_CANCELLATION_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, cancelInteractionCommandV1) + sizeof(std::declval<RockProviderApi>().cancelInteractionCommandV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_INPUT_OBSERVABILITY_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getHandInputSuppressionStateV1) + sizeof(std::declval<RockProviderApi>().getHandInputSuppressionStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_OFFHAND_RESERVATION_LEASES_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getOffhandReservationStateV1) + sizeof(std::declval<RockProviderApi>().getOffhandReservationStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_NATIVE_ANIMATION_RUNTIME_CLEAR_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearNativeAnimationRuntimeV1) + sizeof(std::declval<RockProviderApi>().clearNativeAnimationRuntimeV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_TOUCH_GRAB_TARGETS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestTouchGrabYieldV1) + sizeof(std::declval<RockProviderApi>().requestTouchGrabYieldV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_HAND_REQUEST_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestEquippedWeaponHandV1) + sizeof(std::declval<RockProviderApi>().requestEquippedWeaponHandV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_WORLD_RAYCASTS_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, queryWorldRaycastV1) + sizeof(std::declval<RockProviderApi>().queryWorldRaycastV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_COLLIDER_VISUALIZATION_OVERRIDE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, clearColliderVisualizationOverrideV1) + sizeof(std::declval<RockProviderApi>().clearColliderVisualizationOverrideV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_LOGICAL_INPUT_ACTION_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getLogicalInputActionStateV1) + sizeof(std::declval<RockProviderApi>().getLogicalInputActionStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PLAYER_CONTROLLER_STATE_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, getPlayerControllerStateV1) + sizeof(std::declval<RockProviderApi>().getPlayerControllerStateV1));
    inline constexpr std::uint32_t ROCK_PROVIDER_API_V1_PLAYER_CONTROLLER_JUMP_TABLE_BYTES =
        static_cast<std::uint32_t>(offsetof(RockProviderApi, requestPlayerControllerJumpV1) + sizeof(std::declval<RockProviderApi>().requestPlayerControllerJumpV1));

    [[nodiscard]] inline bool queryProviderLimitsV1(RockProviderLimitsV1& outLimits)
    {
        constexpr auto limitsTableBytes = static_cast<std::uint32_t>(offsetof(RockProviderApi, getProviderLimitsV1) + sizeof(std::declval<RockProviderApi>().getProviderLimitsV1));
        if (!RockProviderApi::inst || (RockProviderApi::negotiatedTableByteSize != 0 && RockProviderApi::negotiatedTableByteSize < limitsTableBytes) ||
    ...
    [[nodiscard]] inline bool queryProviderLimitsExtV1(RockProviderLimitsExtV1& outLimits)
    {
        ...
        if (RockProviderApi::negotiatedTableByteSize != 0) {
            if (RockProviderApi::negotiatedTableByteSize < ROCK_PROVIDER_API_V1_EXTENDED_LIMITS_TABLE_BYTES) {
                return false;
            }
        } else {
            RockProviderLimitsV1 baseLimits{};
            if (!queryProviderLimitsV1(baseLimits) || baseLimits.providerApiByteSize < ROCK_PROVIDER_API_V1_EXTENDED_LIMITS_TABLE_BYTES) {
                return false;
            }
        }
    ...
    {
        if (RockProviderApi::negotiatedTableByteSize != 0) {
            return requiredByteSize != 0 && RockProviderApi::negotiatedTableByteSize >= requiredByteSize;
        }
        RockProviderLimitsV1 limits{};
        return queryProviderLimitsV1(limits) && providerApiTableSupportsV1(limits, requiredByteSize);
    }

    [[nodiscard]] inline bool providerSupportsFeature2V1(std::uint32_t requiredByteSize, RockProviderFeatureBit2V1 feature)
    {
        if (!providerApiTableSupportsV1(requiredByteSize)) {
            return false;
        }
        if (RockProviderApi::negotiatedTableByteSize != 0) {
            return hasFeatureBit2V1(RockProviderApi::negotiatedFeatureBits2, feature);
        }
        RockProviderLimitsExtV1 limits{};
        return queryProviderLimitsExtV1(limits) && hasFeatureBit2V1(limits.featureBits2, feature);
    }
    ...
    {
        return providerApiTableSupportsV1(limits, ROCK_PROVIDER_API_V1_WEAPON_CLASSIFICATION_TABLE_BYTES);
    }
    ...
    [[nodiscard]] inline bool supportsEquippedWeaponHandRequestV1(const RockProviderLimitsV1& limits)
    {
        return providerApiTableSupportsV1(limits, ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_HAND_REQUEST_TABLE_BYTES) &&
            hasFeatureBitV1(limits.featureBits, RockProviderFeatureBitV1::EquippedWeaponHandRequest);
    }

    [[nodiscard]] inline bool supportsEquippedWeaponHandRequestV1()
    {
        RockProviderLimitsV1 limits{};
        return queryProviderLimitsV1(limits) && supportsEquippedWeaponHandRequestV1(limits);
    }
    ...
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_EXTENDED_LIMITS_TABLE_BYTES, RockProviderFeatureBit2V1::ExtendedLimits);
    }

    [[nodiscard]] inline bool supportsOwnerFrameCallbacksV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_OWNER_FRAME_CALLBACKS_TABLE_BYTES, RockProviderFeatureBit2V1::OwnerFrameCallbacks);
    }

    [[nodiscard]] inline bool supportsHandInteractionStateV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_HAND_INTERACTION_STATE_TABLE_BYTES, RockProviderFeatureBit2V1::HandInteractionState);
    }

    [[nodiscard]] inline bool supportsProviderEventsV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_PROVIDER_EVENTS_TABLE_BYTES, RockProviderFeatureBit2V1::ProviderEvents);
    }

    [[nodiscard]] inline bool supportsEquippedWeaponStateV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_EQUIPPED_WEAPON_STATE_TABLE_BYTES, RockProviderFeatureBit2V1::EquippedWeaponState);
    }

    [[nodiscard]] inline bool supportsExternalBodyScopesV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_EXTERNAL_BODY_SCOPES_TABLE_BYTES, RockProviderFeatureBit2V1::ExternalBodyScopes);
    }

    [[nodiscard]] inline bool supportsWeaponPartObservabilityV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_WEAPON_PART_OBSERVABILITY_TABLE_BYTES, RockProviderFeatureBit2V1::WeaponPartDriveResults);
    }

    [[nodiscard]] inline bool supportsScopeSightStateV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_SCOPE_SIGHT_STATE_TABLE_BYTES, RockProviderFeatureBit2V1::ScopeSightState);
    }

    [[nodiscard]] inline bool supportsWeaponCompositionV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_WEAPON_COMPOSITION_TABLE_BYTES, RockProviderFeatureBit2V1::WeaponComposition);
    }

    [[nodiscard]] inline bool supportsPoseReadbackV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_POSE_READBACK_TABLE_BYTES, RockProviderFeatureBit2V1::PresentedHandPose);
    }

    [[nodiscard]] inline bool supportsSemanticHandContactsV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_SEMANTIC_HAND_CONTACTS_TABLE_BYTES, RockProviderFeatureBit2V1::SemanticHandContacts);
    }

    [[nodiscard]] inline bool supportsPlayerColliderDescriptorsV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_PLAYER_COLLIDERS_TABLE_BYTES, RockProviderFeatureBit2V1::PlayerColliderDescriptors);
    }

    [[nodiscard]] inline bool supportsCommandCancellationV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_COMMAND_CANCELLATION_TABLE_BYTES, RockProviderFeatureBit2V1::CommandCancellation);
    }

    [[nodiscard]] inline bool supportsInputObservabilityV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_INPUT_OBSERVABILITY_TABLE_BYTES, RockProviderFeatureBit2V1::InputSuppressionState);
    }

    [[nodiscard]] inline bool supportsNativeVatsVansInputSuppressionV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_HAND_INPUT_SUPPRESSION_TABLE_BYTES, RockProviderFeatureBit2V1::NativeVatsVansInputSuppression);
    }

    [[nodiscard]] inline bool supportsOffhandReservationLeasesV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_OFFHAND_RESERVATION_LEASES_TABLE_BYTES, RockProviderFeatureBit2V1::OffhandReservationLeases);
    }

    [[nodiscard]] inline bool supportsTouchGrabTargetsV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_TOUCH_GRAB_TARGETS_TABLE_BYTES, RockProviderFeatureBit2V1::TouchGrabTargets);
    }

    [[nodiscard]] inline bool supportsWorldRaycastsV1()
    {
        return providerSupportsFeature2V1(ROCK_PROVIDER_API_V1_WORLD_RAYCASTS_TABLE_BYTES, RockProviderFeatureBit2V1::WorldRaycasts);
    }

    [[nodiscard]] inline bool supportsColliderVisualizationOverrideV1(const RockProviderLimitsV1& limits)
    {
        return providerApiTableSupportsV1(limits, ROCK_PROVIDER_API_V1_COLLIDER_VISUALIZATION_OVERRIDE_TABLE_BYTES) &&
            hasFeatureBitV1(limits.featureBits, RockProviderFeatureBitV1::ColliderVisualizationOverride);
    }

    [[nodiscard]] inline bool supportsColliderVisualizationOverrideV1()
    {
        RockProviderLimitsV1 limits{};
        return queryProviderLimitsV1(limits) && supportsColliderVisualizationOverrideV1(limits);
    }

    [[nodiscard]] inline bool supportsLogicalInputActionStateV1()
    {
        return providerApiTableSupportsV1(ROCK_PROVIDER_API_V1_LOGICAL_INPUT_ACTION_STATE_TABLE_BYTES);
    }

    [[nodiscard]] inline bool supportsPlayerControllerStateV1()
    {
        return providerApiTableSupportsV1(ROCK_PROVIDER_API_V1_PLAYER_CONTROLLER_STATE_TABLE_BYTES);
    }

    [[nodiscard]] inline bool supportsPlayerControllerJumpV1()
    {
        return providerApiTableSupportsV1(ROCK_PROVIDER_API_V1_PLAYER_CONTROLLER_JUMP_TABLE_BYTES);
    }
    ...
    public:
        ...
        static constexpr std::uint32_t RequiredCapabilities = static_cast<std::uint32_t>(RockProviderConsumerCapabilityV1::FrameSnapshots) |
            static_cast<std::uint32_t>(RockProviderConsumerCapabilityV1::HandInteractionState) | static_cast<std::uint32_t>(RockProviderConsumerCapabilityV1::InteractionCommands);
        ...
        [[nodiscard]] Reference* GetHeldItem(bool isLeft, RockProviderResultV1* outResult = nullptr) const
        {
        ...
        [[nodiscard]] RockGrabItemRequestResult RequestGrabItem(bool isLeft, const Reference* reference, float maxDistanceGame = 0.0f) const
        {
            ...
            if (!providerApiTableSupportsV1(ROCK_PROVIDER_API_V1_FORCE_GRAB_TABLE_BYTES) || !supportsForceGrabCommandV1() || !RockProviderApi::inst->requestForceGrabV1 ||
            ...
            if (!RockProviderApi::inst->getFrameSnapshot || !RockProviderApi::inst->getFrameSnapshot(&snapshot) || snapshot.worldGeneration == 0 ||
                snapshot.skeletonGeneration == 0 || snapshot.providerGeneration == 0) {
                return {};
            }
            ...
            admission.result = RockProviderApi::inst->requestForceGrabV1(_ownerToken, &request, &admission.commandId);
            return admission;
        }

    private:
        [[nodiscard]] RockProviderResultV1 queryHeldItem(bool isLeft, Reference*& reference) const
        {
            ...
            if (!supportsHandInteractionStateV1() || !RockProviderApi::inst->getHandInteractionStateV1) {
                return RockProviderResultV1::UnsupportedVersion;
            }
            RockProviderHandInteractionStateV1 state{};
            const auto result = RockProviderApi::inst->getHandInteractionStateV1(_ownerToken, isLeft ? RockProviderHand::Left : RockProviderHand::Right, &state);
            ...
            const bool held = state.targetKind == RockProviderBodyContactTargetKind::HeldObject ||
                (state.phase == RockProviderHandInteractionPhaseV1::Holding && (state.flags & static_cast<std::uint32_t>(RockProviderHandInteractionFlagV1::TouchGrab)) != 0);
    ...
    static_assert(offsetof(RockProviderApi, getProviderLimitsExtV1) == 54 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, clearNativeAnimationRuntimeV1) == 81 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, requestTouchGrabYieldV1) == 85 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, requestEquippedWeaponHandV1) == 86 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, queryWorldRaycastV1) == 87 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, setColliderVisualizationOverrideV1) == 88 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, clearColliderVisualizationOverrideV1) == 89 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, getLogicalInputActionStateV1) == 90 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, getPlayerControllerStateV1) == 91 * sizeof(void*));
    static_assert(offsetof(RockProviderApi, requestPlayerControllerJumpV1) == 92 * sizeof(void*));
}
